...
export const adminApi = {
  ...
  exportTimeLogs: async (
    ...
    if (typeof params.month === "number")
      finalParams.month = String(params.month);
  ...
  getTimeLogs: async (
    ...
    const response = await axiosInstance.get<TimeLogsResponse>(
      "/admin/time/logs",
      { params: finalParams }
    );
  ...
  deleteTimeLog: async (
    ...
    const response = await axiosInstance.delete(`/admin/time/logs/${id}`);
