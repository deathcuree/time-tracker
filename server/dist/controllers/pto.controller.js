...
const createDateSearchConditions = (searchStr) => {
...
export const getUserRequests = async (req, res) => {
    try {
        ...
        const transformedRequests = requests.map(request => ({
            ...
            userEmail: request.userId.email || 'No Email'
        }));
...
export const updateRequestStatus = async (req, res) => {
    try {
        ...
        if (ptoRequest.userId) {
            ptoRequest.userName = `${ptoRequest.userId.firstName} ${ptoRequest.userId.lastName}`;
            ptoRequest.userEmail = ptoRequest.userId.email;
        }
        await ptoRequest.save();
...
export const getMonthlyRequestCount = async (req, res) => {
    try {
...
export const getYearlyPTOHours = async (req, res) => {
    try {
